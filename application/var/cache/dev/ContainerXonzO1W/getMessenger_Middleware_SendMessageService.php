...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Queue\\Message\\Message\\TrackAction' => [0 => 'tracker']], ($container->privates['.service_locator.oQ5QZmk'] ?? $container->load('get_ServiceLocator_OQ5QZmkService'))), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
